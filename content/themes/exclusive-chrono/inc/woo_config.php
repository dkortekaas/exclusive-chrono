...
if ( ! class_exists( 'Avada_Woocommerce' ) ) {
		 ...
		 * @access 
		 */
		 function avada_woocommerce_add_product_wrappers_open() {
			?>
		 ...
		 */
		 function product_title() {
			?>
			<span class="product-name"><a href="<?php echo get_the_permalink(); ?>"><?php echo get_the_title(); ?></a></h3>
		 ...
		 * @access 
		 */
		 function avada_woocommerce_add_product_wrappers_close() {
			?>
					</div>
		 ...
		 * @access 
		 */
		 function avada_woocommerce_template_single_title() {
			?>
		 ...
		 * @access 
		 */
		 function avada_woocommerce_stock_html() {
			global $product;
		 ...
		 * Cart Page functions.
		 */
		 function avada_woocommerce_proceed_to_checkout() {
			?>
...
function cart_shipping_calc() {
	...
	<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
		...
		<div class="avada-shipping-calculator-form">
			...
			<div class="avada-select-parent fusion-layout-column fusion-one-half fusion-spacing-yes">
				<?php
